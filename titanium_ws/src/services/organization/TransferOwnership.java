...
public class TransferOwnership extends HttpServlet {
	private static final long serialVersionUID = -4527890934966867506L;
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			if (!ServicesTools.nullChecker(key, idOrga, idUser)) {
				answer = OrganizationUtils.transferOwnership(key, idOrga, idUser);
			} else {
